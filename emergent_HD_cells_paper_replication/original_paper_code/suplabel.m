...
currax=[currax;findobj(gcf,'tag','legend')];% CJC 2014
...
if ~(ischar(text) || (iscell(text) && all(cellfun(@ischar,text))))% CJC 2014 
error('text must be a string or a cell string')% CJC 2014  
end% CJC 2014  
if ~ischar(whichLabel)% CJC 2014  
error('whichLabel must be a string')% CJC 2014  
end% CJC 2014 
