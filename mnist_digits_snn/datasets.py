...
class MNISTSequencesSupervisedDataset(Dataset):

    def __init__(self, file_path, targets_path, LIF_linear_features, ingest_numpy_dtype, ingest_torch_dtype, transform=None):
        """
        Arguments:
            file_path (string): Path to the npy file with sequences.
            transform (callable, optional): Optional transform to be applied
